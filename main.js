...
var $author$project$Main$init = {
	alchemySet: _List_Nil,
	changeSet: $elm$core$Basics$always(_List_Nil),
	changeTable: $elm$core$Basics$always(_List_Nil),
	combinationTable: _List_Nil,
	elementSelectDisplay: $author$project$Main$Hidden,
	page: 0,
	previousSet: _List_Nil
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$initWithCmd = _Utils_Tuple2($author$project$Main$init, $elm$core$Platform$Cmd$none);
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Main$nextLevelSFX = _Platform_outgoingPort('nextLevelSFX', $elm$json$Json$Encode$string);
var $author$project$Main$SetSelect = {$: 'SetSelect'};
var $author$project$Main$TableSelect = {$: 'TableSelect'};
		...
		switch (msg.$) {
			case 'NextPage':
				return _Utils_update(
					model,
					{page: model.page + 1, previousSet: model.alchemySet});
			case 'ChangeSet':
				var x = msg.a;
				return _Utils_update(
					model,
					{
						changeSet: function (c) {
							return A3($elm_community$list_extra$List$Extra$setAt, x, c, model.alchemySet);
						},
						elementSelectDisplay: $author$project$Main$SetSelect
					});
			case 'ChangeTable':
				var x = msg.a;
				var y = msg.b;
							...
							return A3(
								...
								A3(
									...
									A2(
										...
										_List_Nil,
										A2($elm_community$list_extra$List$Extra$getAt, x, model.combinationTable))),
								model.combinationTable);
						},
						elementSelectDisplay: $author$project$Main$TableSelect
					});
			case 'PopElement':
				return _Utils_update(
					model,
					{
						alchemySet: A2(
							$elm$core$Maybe$withDefault,
							_List_Nil,
							$elm_community$list_extra$List$Extra$init(model.alchemySet)),
						combinationTable: A2(
							$elm$core$List$map,
							function (row) {
								return A2(
									$elm$core$Maybe$withDefault,
									_List_Nil,
									$elm_community$list_extra$List$Extra$init(row));
							},
							A2(
								$elm$core$Maybe$withDefault,
								_List_Nil,
								$elm_community$list_extra$List$Extra$init(model.combinationTable)))
					});
			case 'PushElement':
				return _Utils_update(
					model,
						...
						combinationTable: A2(
							...
							A2(
								...
								$elm$core$List$singleton(
									A2(
										$elm$core$List$repeat,
										$elm$core$List$length(model.alchemySet),
										_Utils_chr('_')))))
					});
			case 'CharSelected':
				var c = msg.a;
				var changedModel = _Utils_eq(model.elementSelectDisplay, $author$project$Main$TableSelect) ? _Utils_update(
					model,
					{
						combinationTable: model.changeTable(c)
					}) : _Utils_update(
					model,
					{
						alchemySet: model.changeSet(c)
					});
				return _Utils_update(
					changedModel,
					{elementSelectDisplay: $author$project$Main$Hidden});
			case 'SwapRowAndColumn':
				var x = msg.a;
				var y = msg.b;
				return _Utils_update(
					model,
					{
						alchemySet: A3($elm_community$list_extra$List$Extra$swapAt, x, y, model.alchemySet),
						combinationTable: A3(
			...
			default:
				var msgs = msg.a;
				return A3($elm$core$List$foldl, $author$project$Main$update, model, msgs);
		}
	});
var $author$project$Main$updateWithCmd = F2(
	function (msg, model) {
		return _Utils_Tuple2(
			A2($author$project$Main$update, msg, model),
			$author$project$Main$nextLevelSFX(''));
	});
...
var $author$project$Main$SwapRowAndColumn = F2(
	function (a, b) {
		return {$: 'SwapRowAndColumn', a: a, b: b};
	});
...
var $author$project$Main$view = function (model) {
	...
	var staticTableTemplate = F2(
		function (aSet, aTable) {
			return A2(
				$elm$html$Html$table,
				_List_Nil,
				_List_fromArray(
								...
								[
									...
									function (c) {
										return A2(
											...
											_List_fromArray(
												[
													A2($elm$html$Html$Attributes$style, 'border-bottom', '5px solid #111111')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text(
									...
									A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														A2($elm$html$Html$Attributes$style, 'border-right', '5px solid #111111')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text(
														$elm$core$String$fromChar(alchemyElement))
													]))
											]),
										A2(
											$elm$core$List$map,
		...
		function (a, b, a2, b2) {
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('This alchemy is valid - '),
							A2(
							staticTableTemplate,
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('This alchemy is not - '),
							A2(
							staticTableTemplate,
							_List_fromArray(
								[
	...
	var identityElement = A2(
		$elm$core$Maybe$withDefault,
		_Utils_chr('I'),
		$elm$core$List$head(model.alchemySet));
	var groupCheck = ((A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					nextButtonEnable(
					groupCheck && (3 === $elm$core$List$length(model.alchemySet)))
				])),
			A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Row/Column Swapping')
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
					...
					_List_fromArray(
						[
							...
							$author$project$Main$Messages(
								_List_fromArray(
									[
										$author$project$Main$NextPage,
										A2($author$project$Main$SwapRowAndColumn, 1, 2)
									])))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Swap 2nd and 3rd; Next')
						]))
				])),
			A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					A3(
						...
						model.previousSet,
						A3($elm_community$list_extra$List$Extra$swapAt, 1, 2, model.previousSet))),
					nextButtonEnable(
					_Utils_eq(model.alchemySet, model.previousSet) && (groupCheck && (3 === $elm$core$List$length(model.alchemySet))))
				])),
			A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Let\'s now get into some serious alchemy. We want to make a specific structure for your table.\n                    To move on, make your table one that fills in the missing table from the example below and also follows all\n                            previous rules.')
						])),
					$elm$html$Html$text('This is your template, fill in the \'-\' as you see fit while following the rules:'),
					A2(
					staticTableTemplate,
					_List_fromArray(
						[
					...
					nextButtonEnable(
					groupCheck && (_Utils_eq(
						$elm$core$Maybe$Just(identityElement),
						A2(
							...
							A2(
								$elm$core$Maybe$withDefault,
								_List_Nil,
								A2($elm_community$list_extra$List$Extra$getAt, 1, model.combinationTable)))) && (_Utils_eq(
						$elm$core$Maybe$Just(identityElement),
						A2(
							$elm_community$list_extra$List$Extra$getAt,
							2,
							A2(
								$elm$core$Maybe$withDefault,
								_List_Nil,
								A2($elm_community$list_extra$List$Extra$getAt, 2, model.combinationTable)))) && (4 === $elm$core$List$length(model.alchemySet)))))
				])),
			A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('To move on, make your table one that fills in the new missing table and also follows all\n                            previous rules.')
						])),
					$elm$html$Html$text('This is your template, fill in the \'-\' as you see fit while following the rules:'),
					A2(
					staticTableTemplate,
					...
					groupCheck && (_Utils_eq(
						...
						A2(
							...
							A2(
								$elm$core$Maybe$withDefault,
								_List_Nil,
								A2($elm_community$list_extra$List$Extra$getAt, 1, model.combinationTable)))) && (4 === $elm$core$List$length(model.alchemySet))))
				])),
			A2(
			$elm$html$Html$div,
			_List_Nil,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Mapping to part 2')
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Swap 2nd and 3rd')
						])),
					nextButtonEnable(
					groupCheck && (_Utils_eq(model.alchemySet, model.previousSet) && (_Utils_eq(
						$elm$core$Maybe$Just(identityElement),
						A2(
							$elm_community$list_extra$List$Extra$getAt,
							3,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Mapping from part 2')
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('Now lets make a mapping from part 2 to part 3. As a reminder,\n                              the part 3 table has identities like this:')
						])),
					A2(
					staticTableTemplate,
					model.previousSet,
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							A2($author$project$Main$SwapRowAndColumn, 2, 3))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Swap 3rd and 4th')
						])),
					nextButtonEnable(
					groupCheck && (_Utils_eq(model.alchemySet, model.previousSet) && (_Utils_eq(
						$elm$core$Maybe$Just(identityElement),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('The previous examples show that the structures of tables 2, 3, and 4 are identical.\n                              Now try to make a 5 by 5 table, notice what way said table can be made, and if there are\n                              any others.')
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							A2($author$project$Main$SwapRowAndColumn, 3, 4))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Swap 4th and 5th')
						])),
					nextButtonEnable(
					groupCheck && (5 === $elm$core$List$length(model.alchemySet)))
				]))
		]);
	var alchemyRange = A2(
		$elm$core$List$range,
		0,
		$elm$core$List$length(model.alchemySet) - 1);
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						A2($elm_community$list_extra$List$Extra$getAt, model.page, pages)),
						A2(
						$elm$html$Html$h2,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('Combination Table')
							]))
					])),
				A2(
				$elm$html$Html$table,
											...
											function (_v2) {
												...
												return A2(
													...
													_List_fromArray(
														[
															$elm$html$Html$Events$onClick(
															A2($author$project$Main$ChangeTable, n, n2))
														]),
													_List_fromArray(
														[
															$elm$html$Html$text(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'visibility',
						(!_Utils_eq(model.elementSelectDisplay, $author$project$Main$Hidden)) ? 'visible' : 'collapse')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Select an Element Below:'),
						A2(
						$elm$html$Html$table,
						_List_Nil,
						_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src('./96546__timkahn__the-next-level.wav'),
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return $author$project$Main$initWithCmd;
		},
		subscriptions: function (_v1) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Main$updateWithCmd,
